...
- `quota_management/` - rate-limit enforcement on live traffic (rpm/tpm blocks, window reset, pacing headers); budgets and spend tracking stay in their own folders above
